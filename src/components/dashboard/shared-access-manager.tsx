...
import { Loader2, UserCheck, UserPlus, Trash2, Mail, Inbox } from "lucide-react";
...
export function SharedAccessManager() {
  ...
  // Query Kotak Masuk (Permintaan yang ditujukan ke SAYA)
    ...
    <div className="grid grid-cols-1 gap-8 animate-in fade-in duration-500">
      <Card className="border-none shadow-xl bg-white rounded-[2rem] overflow-hidden">
        <CardHeader className="bg-slate-50 border-b px-8 py-6">
          ...
          <CardDescription>Pesan masuk dari tamu yang ingin memantau data Anda.</CardDescription>
        </CardHeader>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="overflow-hidden">
                      ...
                      <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">
                        Terkirim: {safeFormatDate(req.timestamp)}
                      </p>
                    </div>
                  </div>
      ...
      <Card className="border-none shadow-xl bg-white rounded-[2rem] overflow-hidden">
        <CardHeader className="bg-emerald-50/50 border-b px-8 py-6">
          ...
          <CardDescription className="text-emerald-700/70">Daftar akun yang saat ini diizinkan melihat dashboard Anda.</CardDescription>
        </CardHeader>
        <CardContent className="p-8">
          {(!permissions || permissions.length === 0) ? (
            <div className="text-center py-12 opacity-30 flex flex-col items-center gap-3">
              <UserCheck className="h-12 w-12" />
              <p className="italic font-medium">Belum ada tamu terpilih.</p>
            </div>
          ) : (
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="overflow-hidden">
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <p className="text-[10px] text-emerald-600 font-bold uppercase tracking-wider">Terhubung</p>
                      </div>
                    </div>
                  </div>
